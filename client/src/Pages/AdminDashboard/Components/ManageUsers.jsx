...
const ManageUsers = () => {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://retailshieldcybersecurity.onrender.com/api/auth/users", {
        params: {
          page: currentPage,
          limit: usersPerPage,
  ...
  const submitEdit = async () => {
    try {
      await axios.put(`https://retailshieldcybersecurity.onrender.com/api/auth/${editingUserId}`, editForm);
