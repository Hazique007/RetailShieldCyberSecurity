...
const ForgotPassword = () => {
  ...
  const sendOtp = async () => {
    ...
    setLoading(true);
    try {
      await axios.post('https://retailshieldcybersecurity.onrender.com/api/auth/request-otp', { email });
  ...
  const verifyOtp = async () => {
    ...
    setLoading(true);
    try {
      await axios.post('https://retailshieldcybersecurity.onrender.com/api/auth/verify-otp', {
        email: email.trim(),
        otp: otpValue
      });
